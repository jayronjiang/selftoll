...
//Switch
#define  BSP_GPIO_SWITCH_PORT                   CSP_GPIO_PORT_NBR_00                                                 
#define  BSP_GPIO_SWITCH_OUT                    DEF_BIT_30    //P0.30
#define  BSP_GPIO_SWITCH1_OUT                   DEF_BIT_29    //P0.29
...
void  BSP_Init (void)
{
    ...
    CSP_GPIO_Cfg(BSP_GPIO_LED2_PORT,
                 BSP_GPIO_LED2,
                 CSP_GPIO_DIR_OUT,
                 CSP_GPIO_FLAG_MODE_NONE,
                 DEF_NO,
    ...
    CSP_GPIO_Cfg(BSP_GPIO_LED1_PORT,
                 BSP_GPIO_LED1,
                 CSP_GPIO_DIR_OUT,
                 CSP_GPIO_FLAG_MODE_NONE,
                 DEF_NO,
    ...
    //光电开关控制
    CSP_GPIO_Cfg(BSP_GPIO_SWITCH_PORT,
                 BSP_GPIO_SWITCH_OUT,
                 CSP_GPIO_DIR_OUT,
                 CSP_GPIO_FLAG_MODE_NONE,
                 DEF_NO,
