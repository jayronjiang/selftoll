...
void Timer0Init (void)
{
  ...
  T0MR0  = 25-1;                                                 			// 25*10us = 250us           
  T0MCR  = 0x03;                                                                    // MR0产生中断，MR0复位TC                         
  T0TCR  = 0x01;
...
void Timer1Init (void)
{
    ...
    T1MR0  = SMOTO_FREQ_700US-1;                           // 70*10us = 700us           
    T1MCR  = 0x03;                                                      // MR0产生中断，MR0复位TC    
...
/********************************************************************************************************
** 函数名称: Timer3Init
** 功能描述: 1ms timer base, total 10ms
** 输 　 入:
**
** 输　  出:
**
...
void Timer3Init (void)
{
  ...
  T3CTCR = 0;
  T3TC   = 0;
  T3PR   = clk_freq/1000-1;						// 1ms
  T3MR0  = 10-1;                                                      // 10*1ms = 10ms        
  T3MCR  = 0x03;                                                      // Start the timer3       
  T3TCR  = 0x01;
...
** 功能描述: It finds the position of the switch group from the ucSelected DCmotor.
** 输 　 入:
**
** 输　  出:
**
...
/********************************************************************************************************
** 函数名称: DMotoByPos
** 功能描述: It finds the ucSelected DCmotor from the switch group number.
** 输 　 入:
**
** 输　  出:
**
