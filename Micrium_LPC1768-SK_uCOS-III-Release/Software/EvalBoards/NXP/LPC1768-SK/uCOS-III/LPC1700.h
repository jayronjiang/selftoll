...
*********************************************************************************************************/
#define PRIO_0               (0x00)                                     /* 优先级为0                    */
#define PRIO_1               (0x01 << 3)                                /* 优先级为1                    */
#define PRIO_2               (0x02 << 3)                                /* 优先级为2                    */
#define PRIO_3               (0x03 << 3)                                /* 优先级为3                    */
#define PRIO_4               (0x04 << 3)                                /* 优先级为4                    */
#define PRIO_5               (0x05 << 3)                                /* 优先级为5                    */
#define PRIO_6               (0x06 << 3)                                /* 优先级为6                    */
#define PRIO_7          	 (0x07 << 3)                                /* 优先级为7                    */
#define PRIO_8         	     (0x08 << 3)                                /* 优先级为8                    */
#define PRIO_9               (0x09 << 3)                                /* 优先级为9                    */
#define PRIO_10              (0x0A << 3)                                /* 优先级为11                   */
#define PRIO_11              (0x0B << 3)                                /* 优先级为11                   */
#define PRIO_12    	         (0x0C << 3)                                /* 优先级为12                   */
#define PRIO_13          	 (0x0D << 3)                                /* 优先级为13                   */
#define PRIO_14         	 (0x0E << 3)                                /* 优先级为14                   */
#define PRIO_15          	 (0x0F << 3)                                /* 优先级为15                   */
#define PRIO_16              (0x10 << 3)                                /* 优先级为16                   */
#define PRIO_17  	         (0x11 << 3)                                /* 优先级为17                   */
#define PRIO_18   	         (0x12 << 3)                                /* 优先级为18                   */
#define PRIO_19    	         (0x13 << 3)                                /* 优先级为19                   */
#define PRIO_20      	     (0x14 << 3)                                /* 优先级为20                   */
#define PRIO_21  	         (0x15 << 3)                                /* 优先级为21                   */
#define PRIO_22   	         (0x16 << 3)                                /* 优先级为22                   */
#define PRIO_23              (0x17 << 3)                                /* 优先级为23                   */
#define PRIO_24              (0x18 << 3)                                /* 优先级为24                   */
#define PRIO_25              (0x19 << 3)                                /* 优先级为25                   */
#define PRIO_26              (0x1A << 3)                                /* 优先级为26                   */
#define PRIO_27              (0x1B << 3)                                /* 优先级为27                   */
#define PRIO_28              (0x1C << 3)                                /* 优先级为28                   */
#define PRIO_29              (0x1D << 3)                                /* 优先级为29                   */
#define PRIO_30              (0x1E << 3)                                /* 优先级为30                   */
#define PRIO_31              (0x1F << 3)                                /* 优先级为31                   */
