...
typedef unsigned char  int8u;                    /* ?T¡¤?o?8????D¨ª¡À?¨¢?  */
typedef signed   char  int8s;                    /* ¨®D¡¤?o?8????D¨ª¡À?¨¢?  */
typedef unsigned short int16u;                   /* ?T¡¤?o?16????D¨ª¡À?¨¢? */
typedef signed   short int16s;                   /* ¨®D¡¤?o?16????D¨ª¡À?¨¢? */
typedef unsigned int   int32u;                   /* ?T¡¤?o?32????D¨ª¡À?¨¢? */
typedef signed   int   int32s;                   /* ¨®D¡¤?o?32????D¨ª¡À?¨¢? */
typedef float          fp32;                     /*  ¦Ì£¤???¨¨??¦Ì?¨ºy¡ê¡§32??3¡è?¨¨¡ê?  */
typedef double         fp64;                     /*  ?????¨¨??¦Ì?¨ºy¡ê¡§64??3¡è?¨¨¡ê?  */
